"""
Dieses Modul beschreibt eine Türklasse mit den Zuständen 'geöffnet'
und 'verriegelt'. Die Klasse Door implementiert die grundlegende
Funktionalität einer Tür, einschließlich Öffnen, Schließen,
...
class Door:
  ...
  Die Tür überwacht die beiden Zustände und verhindert
  unzulässige Aktionen. Das Verriegeln delegiert die Tür
